...
bool Core::Renderer::MeshPipeline::init(Core::Renderer::VkRenderData& renderData, VkPipelineLayout& pipelineLayout,
...
void Core::Renderer::MeshPipeline::cleanup(Core::Renderer::VkRenderData& renderData, VkPipeline& pipeline)
{
