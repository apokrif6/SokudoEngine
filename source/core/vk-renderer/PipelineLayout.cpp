...
bool Core::Renderer::PipelineLayout::init(Core::Renderer::VkRenderData& renderData, VkTextureArrayData& textureData,
                                          VkPipelineLayout& pipelineLayout)
{
    VkDescriptorSetLayout layouts[] = {textureData.descriptorSetLayout,
                                       renderData.rdPerspectiveViewMatrixUBO.rdUBODescriptorLayout,
                                       renderData.rdJointMatrixSSBO.rdSSBODescriptorLayout};
