...
void Core::Application::Window::bindInputs()
{
    ...
    glfwSetWindowPosCallback(mWindow,
                             ...
                             {
                                 Core::Engine::getInstance().getSystem<Core::Renderer::VkRenderer>()->handleWindowMoveEvents(
                                         xPosition, yPosition);
                             });
    ...
    glfwSetWindowIconifyCallback(mWindow,
                                 ...
                                 {
                                     Core::Engine::getInstance().getSystem<Core::Renderer::VkRenderer>()->handleWindowMinimizedEvents(
                                             minimized);
                                 });
    ...
    glfwSetWindowMaximizeCallback(mWindow,
                                  ...
                                  {
                                      Core::Engine::getInstance().getSystem<Core::Renderer::VkRenderer>()->handleWindowMaximizedEvents(
                                              maximized);
                                  });
    ...
    glfwSetFramebufferSizeCallback(mWindow,
                                   ...
                                   {
                                       Core::Engine::getInstance().getSystem<Core::Renderer::VkRenderer>()->handleWindowResizeEvents(
                                               width, height);
                                   });
    ...
    glfwSetCursorEnterCallback(mWindow,
                               ...
                               {
                                   Core::Engine::getInstance().getSystem<Core::Renderer::VkRenderer>()->handleMouseEnterLeaveEvents(
                                           enter);
                               });
}
