...
#include "GltfModel.h"
#include "vk-renderer/VertexBuffer.h"
#include "vk-renderer/IndexBuffer.h"
...
void GltfModel::uploadVertexBuffers(VkRenderData& renderData, VkGltfRenderData& gltfRenderData)
{
    for (int i = 0; i < 3; ++i)
    {
        ...
        VertexBuffer::uploadData(renderData, gltfRenderData.rdGltfVertexBufferData.at(i), buffer, bufferView);
    }
}
...
void GltfModel::uploadPositionBuffer(VkRenderData& renderData, VkGltfRenderData& gltfRenderData)
{
    ...
    VertexBuffer::uploadData(renderData, gltfRenderData.rdGltfVertexBufferData.at(0), mAlteredPositions);
}
...
void GltfModel::uploadIndexBuffer(VkRenderData& renderData, VkGltfRenderData& gltfRenderData)
{
    ...
    IndexBuffer::uploadData(renderData, gltfRenderData.rdGltfIndexBufferData, indexBuffer, indexBufferView);
}
...
void GltfModel::createVertexBuffers(VkRenderData& renderData, VkGltfRenderData& gltfRenderData)
{
    ...
    for (const auto& attrib : primitives.attributes)
    {
        ...
        VertexBuffer::init(renderData, gltfRenderData.rdGltfVertexBufferData.at(attributes.at(attribType)),
