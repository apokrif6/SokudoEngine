...
bool GltfSkeletonPipeline::init(VkRenderData& renderData, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
...
void GltfSkeletonPipeline::cleanup(VkRenderData& renderData, VkPipeline& pipeline)
{
